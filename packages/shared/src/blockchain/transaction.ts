...
import { getMockWalletClient, getWalletClient } from "./wallet";

interface TransactionExecutionParams {
  ethereumClient: PublicClient;
  walletClientData: ReturnType<typeof getWalletClient | typeof getMockWalletClient>;
...
export const executeTransaction = async ({
  ...
  const { nonce, maxFeePerGas, maxPriorityFeePerGas, value } = contractCallOptions ?? {};
