...
export interface MockL1ScrollMessengerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "dropMessage"
...
export interface MockL1ScrollMessenger extends BaseContract {
  connect(runner?: ContractRunner | null): MockL1ScrollMessenger;
  waitForDeployment(): Promise<this>;

  interface: MockL1ScrollMessengerInterface;
